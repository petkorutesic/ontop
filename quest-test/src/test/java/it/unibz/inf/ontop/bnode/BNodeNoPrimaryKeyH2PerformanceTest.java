...
/***
 * Performance test for the use of unlabeled blank nodes in mappings with an H2 database
...
public class BNodeNoPrimaryKeyH2PerformanceTest extends TestCase {
    ...
    final String obdafile = "src/test/resources/bnode/ontoWisbenchNoPKPerformanceTestH2.obda";
