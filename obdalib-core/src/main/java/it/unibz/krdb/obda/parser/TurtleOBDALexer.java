...
public class TurtleOBDALexer extends Lexer {
	...
	public final void mBASE() throws RecognitionException {
		try {
			int _type = BASE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:751:5: ( ( 'B' | 'b' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
			// TurtleOBDA.g:751:7: ( 'B' | 'b' ) ( 'A' | 'a' ) ( 'S' | 's' ) ( 'E' | 'e' )
			{
	...
	public final void mPREFIX() throws RecognitionException {
		try {
			int _type = PREFIX;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:753:7: ( ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'X' | 'x' ) )
			// TurtleOBDA.g:753:9: ( 'P' | 'p' ) ( 'R' | 'r' ) ( 'E' | 'e' ) ( 'F' | 'f' ) ( 'I' | 'i' ) ( 'X' | 'x' )
			{
	...
	public final void mFALSE() throws RecognitionException {
		try {
			int _type = FALSE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:755:6: ( ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'S' | 's' ) ( 'E' | 'e' ) )
			// TurtleOBDA.g:755:8: ( 'F' | 'f' ) ( 'A' | 'a' ) ( 'L' | 'l' ) ( 'S' | 's' ) ( 'E' | 'e' )
			{
			if ( input.LA(1)=='F'||input.LA(1)=='f' ) {
				input.consume();
			}
	...
	public final void mTRUE() throws RecognitionException {
		try {
			int _type = TRUE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:757:5: ( ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'E' | 'e' ) )
			// TurtleOBDA.g:757:7: ( 'T' | 't' ) ( 'R' | 'r' ) ( 'U' | 'u' ) ( 'E' | 'e' )
			{
	...
	public final void mUNDERSCORE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:776:11: ( '_' )
			// TurtleOBDA.g:776:16: '_'
			{
			match('_'); 
			}
	...
	public final void mBLANK_PREFIX() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:793:13: ( '_:' )
			// TurtleOBDA.g:793:16: '_:'
			{
			match("_:"); 
	...
	public final void mALPHA() throws RecognitionException {
		try {
			// TurtleOBDA.g:798:3: ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00C0' .. '\\u00D6' | '\\u00D8' .. '\\u00F6' | '\\u00F8' .. '\\u02FF' | '\\u0370' .. '\\u037D' | '\\u037F' .. '\\u1FFF' | '\\u200C' .. '\\u200D' | '\\u2070' .. '\\u218F' | '\\u2C00' .. '\\u2FEF' | '\\u3001' .. '\\uD7FF' | '\\uF900' .. '\\uFDCF' | '\\uFDF0' .. '\\uFFFD' )
			// TurtleOBDA.g:
			{
	...
	public final void mALPHANUM() throws RecognitionException {
		try {
			// TurtleOBDA.g:818:3: ( ALPHA | DIGIT )
			// TurtleOBDA.g:
			{
	...
	public final void mCHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:823:3: ( ALPHANUM | UNDERSCORE | MINUS | PERIOD )
			// TurtleOBDA.g:
			{
	...
	public final void mDOUBLE() throws RecognitionException {
		try {
			int _type = DOUBLE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:834:3: ( ( DIGIT )+ PERIOD ( DIGIT )* ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | PERIOD ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* )
			int alt12=3;
			alt12 = dfa12.predict(input);
			switch (alt12) {
				case 1 :
					// TurtleOBDA.g:834:5: ( DIGIT )+ PERIOD ( DIGIT )* ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )*
					{
					...
					break;
				case 2 :
					// TurtleOBDA.g:835:5: PERIOD ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )*
					{
					mPERIOD(); 
					...
					break;
				case 3 :
					// TurtleOBDA.g:836:5: ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )*
					{
					// TurtleOBDA.g:836:5: ( DIGIT )+
					int cnt9=0;
					loop9:
					while (true) {
						int alt9=2;
	...
	public final void mDECIMAL() throws RecognitionException {
		try {
			int _type = DECIMAL;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:840:3: ( ( DIGIT )+ PERIOD ( DIGIT )+ | PERIOD ( DIGIT )+ )
			int alt16=2;
			...
			switch (alt16) {
				case 1 :
					// TurtleOBDA.g:840:5: ( DIGIT )+ PERIOD ( DIGIT )+
					{
					// TurtleOBDA.g:840:5: ( DIGIT )+
					int cnt13=0;
					loop13:
					while (true) {
						int alt13=2;
					...
					break;
				case 2 :
					// TurtleOBDA.g:841:5: PERIOD ( DIGIT )+
					{
					mPERIOD(); 

					// TurtleOBDA.g:841:12: ( DIGIT )+
					int cnt15=0;
					loop15:
					while (true) {
						int alt15=2;
	...
	public final void mINTEGER_POSITIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:845:3: ( PLUS INTEGER )
			// TurtleOBDA.g:845:5: PLUS INTEGER
			{
			mPLUS(); 
	...
	public final void mINTEGER_NEGATIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:849:3: ( MINUS INTEGER )
			// TurtleOBDA.g:849:5: MINUS INTEGER
			{
			mMINUS(); 
	...
	public final void mDOUBLE_POSITIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:853:3: ( PLUS DOUBLE )
			// TurtleOBDA.g:853:5: PLUS DOUBLE
			{
			mPLUS(); 
	...
	public final void mDOUBLE_NEGATIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:857:3: ( MINUS DOUBLE )
			// TurtleOBDA.g:857:5: MINUS DOUBLE
			{
			mMINUS(); 
	...
	public final void mDECIMAL_POSITIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:861:3: ( PLUS DECIMAL )
			// TurtleOBDA.g:861:5: PLUS DECIMAL
			{
			mPLUS(); 
	...
	public final void mDECIMAL_NEGATIVE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:865:3: ( MINUS DECIMAL )
			// TurtleOBDA.g:865:5: MINUS DECIMAL
			{
			mMINUS(); 
	...
	public final void mVARNAME() throws RecognitionException {
		try {
			int _type = VARNAME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:869:3: ( ALPHA ( CHAR )* )
			// TurtleOBDA.g:869:5: ALPHA ( CHAR )*
			{
			mALPHA(); 

			// TurtleOBDA.g:869:11: ( CHAR )*
			loop17:
			while (true) {
				int alt17=2;
	...
	public final void mECHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:873:3: ( '\\\\' ( 't' | 'b' | 'n' | 'r' | 'f' | '\\\\' | '\"' | '\\'' ) )
			// TurtleOBDA.g:873:5: '\\\\' ( 't' | 'b' | 'n' | 'r' | 'f' | '\\\\' | '\"' | '\\'' )
			{
			match('\\'); 
	...
	public final void mSCHEMA() throws RecognitionException {
		try {
			// TurtleOBDA.g:876:16: ( ALPHA ( ALPHANUM | PLUS | MINUS | PERIOD )* )
			// TurtleOBDA.g:876:18: ALPHA ( ALPHANUM | PLUS | MINUS | PERIOD )*
			{
			mALPHA(); 

			// TurtleOBDA.g:876:24: ( ALPHANUM | PLUS | MINUS | PERIOD )*
			loop18:
			while (true) {
				int alt18=2;
	...
	public final void mURI_PATH() throws RecognitionException {
		try {
			// TurtleOBDA.g:878:18: ( ( ALPHANUM | UNDERSCORE | MINUS | COLON | PERIOD | HASH | QUESTION | SLASH ) )
			// TurtleOBDA.g:
			{
	...
	public final void mID_START() throws RecognitionException {
		try {
			// TurtleOBDA.g:880:18: ( ( ALPHA | UNDERSCORE ) )
			// TurtleOBDA.g:
			{
	...
	public final void mID_CORE() throws RecognitionException {
		try {
			// TurtleOBDA.g:882:17: ( ( ID_START | DIGIT ) )
			// TurtleOBDA.g:
			{
	...
	public final void mID() throws RecognitionException {
		try {
			// TurtleOBDA.g:884:12: ( ID_START ( ID_CORE )* )
			// TurtleOBDA.g:884:14: ID_START ( ID_CORE )*
			{
			mID_START(); 

			// TurtleOBDA.g:884:23: ( ID_CORE )*
			loop19:
			while (true) {
				int alt19=2;
	...
	public final void mNAME_START_CHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:886:25: ( ( ALPHA | UNDERSCORE ) )
			// TurtleOBDA.g:
			{
			if ( (input.LA(1) >= 'A' && input.LA(1) <= 'Z')||input.LA(1)=='_'||(input.LA(1) >= 'a' && input.LA(1) <= 'z')||(input.LA(1) >= '\u00C0' && input.LA(1) <= '\u00D6')||(input.LA(1) >= '\u00D8' && input.LA(1) <= '\u00F6')||(input.LA(1) >= '\u00F8' && input.LA(1) <= '\u02FF')||(input.LA(1) >= '\u0370' && input.LA(1) <= '\u037D')||(input.LA(1) >= '\u037F' && input.LA(1) <= '\u1FFF')||(input.LA(1) >= '\u200C' && input.LA(1) <= '\u200D')||(input.LA(1) >= '\u2070' && input.LA(1) <= '\u218F')||(input.LA(1) >= '\u2C00' && input.LA(1) <= '\u2FEF')||(input.LA(1) >= '\u3001' && input.LA(1) <= '\uD7FF')||(input.LA(1) >= '\uF900' && input.LA(1) <= '\uFDCF')||(input.LA(1) >= '\uFDF0' && input.LA(1) <= '\uFFFD') ) {
				input.consume();
	...
	public final void mNAME_CHAR() throws RecognitionException {
		try {
			// TurtleOBDA.g:888:19: ( ( NAME_START_CHAR | DIGIT | UNDERSCORE | MINUS | PERIOD | HASH | QUESTION | SLASH | PERCENT | EQUALS | SEMI ) )
			// TurtleOBDA.g:
			{
	...
	public final void mNCNAME() throws RecognitionException {
		try {
			int _type = NCNAME;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:891:3: ( NAME_START_CHAR ( NAME_CHAR )* )
			// TurtleOBDA.g:891:5: NAME_START_CHAR ( NAME_CHAR )*
			{
			mNAME_START_CHAR(); 
	...
	public final void mNCNAME_EXT() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:895:3: ( ( NAME_CHAR | LCR_BRACKET | RCR_BRACKET | HASH | SLASH )* )
			// TurtleOBDA.g:895:5: ( NAME_CHAR | LCR_BRACKET | RCR_BRACKET | HASH | SLASH )*
			{
			// TurtleOBDA.g:895:5: ( NAME_CHAR | LCR_BRACKET | RCR_BRACKET | HASH | SLASH )*
			loop21:
			while (true) {
	...
	public final void mNAMESPACE() throws RecognitionException {
		try {
			int _type = NAMESPACE;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:899:3: ( NAME_START_CHAR ( NAME_CHAR )* COLON )
			// TurtleOBDA.g:899:5: NAME_START_CHAR ( NAME_CHAR )* COLON
			{
			mNAME_START_CHAR(); 

			// TurtleOBDA.g:899:21: ( NAME_CHAR )*
			loop22:
			while (true) {
				int alt22=2;
	...
	public final void mPREFIXED_NAME() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:903:3: ( ( NCNAME )? COLON NCNAME_EXT )
			// TurtleOBDA.g:903:5: ( NCNAME )? COLON NCNAME_EXT
			{
			// TurtleOBDA.g:903:5: ( NCNAME )?
			int alt23=2;
	...
	public final void mSTRING_WITH_QUOTE() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:907:3: ( '\\'' ( options {greedy=false; } :~ ( '\\u0027' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '\\'' )
			// TurtleOBDA.g:907:5: '\\'' ( options {greedy=false; } :~ ( '\\u0027' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '\\''
			{
			match('\''); 
			// TurtleOBDA.g:907:10: ( options {greedy=false; } :~ ( '\\u0027' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop24:
			while (true) {
				int alt24=3;
	...
	public final void mSTRING_WITH_QUOTE_DOUBLE() throws RecognitionException {
		try {
			...
			{
			match('\"'); 
			// TurtleOBDA.g:919:10: ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop25:
			while (true) {
				int alt25=3;
	...
	public final void mSTRING_WITH_BRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:923:3: ( '<' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '>' )
			// TurtleOBDA.g:923:5: '<' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '>'
			{
			match('<'); 
			// TurtleOBDA.g:923:9: ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop26:
			while (true) {
				int alt26=3;
	...
	public final void mSTRING_WITH_CURLY_BRACKET() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:927:3: ( '{' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '}' )
			// TurtleOBDA.g:927:5: '{' ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )* '}'
			{
			match('{'); 
			// TurtleOBDA.g:927:9: ( options {greedy=false; } :~ ( '\\u0022' | '\\u005C' | '\\u000A' | '\\u000D' ) | ECHAR )*
			loop27:
			while (true) {
				int alt27=3;
	...
	public final void mSTRING_URI() throws RecognitionException {
		try {
			...
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// TurtleOBDA.g:931:3: ( SCHEMA COLON DOUBLE_SLASH ( URI_PATH )* )
			// TurtleOBDA.g:931:5: SCHEMA COLON DOUBLE_SLASH ( URI_PATH )*
			{
			mSCHEMA(); 
	...
	protected class DFA12 extends DFA {
		...
		public String getDescription() {
			return "833:1: DOUBLE : ( ( DIGIT )+ PERIOD ( DIGIT )* ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | PERIOD ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* | ( DIGIT )+ ( 'e' | 'E' ) ( '-' | '+' )? ( DIGIT )* );";
		}
	}
