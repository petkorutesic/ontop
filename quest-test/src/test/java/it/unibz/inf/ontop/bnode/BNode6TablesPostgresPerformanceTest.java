...
/***
 * Performance test for an use of unlabeled blank nodes in mappings with an PostgreSQL database
 ...
 */
public class BNode6TablesPostgresPerformanceTest {
    final static Logger log = LoggerFactory.getLogger(BNode6TablesPostgresPerformanceTest.class);
    ...
    final String obdafile = "src/test/resources/bnode/ontoWisbench6TablesPerformanceTestPostgres.obda";
