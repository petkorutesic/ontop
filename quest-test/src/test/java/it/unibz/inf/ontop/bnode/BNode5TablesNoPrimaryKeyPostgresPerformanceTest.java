...
/***
 * Performance test for the use of unlabeled blank nodes within mappings with a Postgres database
 * comprised of 5 same tables no primary keys and with rows randomly generated by
 ...
 */
public class BNode5TablesNoPrimaryKeyPostgresPerformanceTest extends TestCase {
    final static Logger log = LoggerFactory.getLogger(BNode5TablesNoPrimaryKeyPostgresPerformanceTest.class);
    ...
    final String obdafile = "src/test/resources/bnode/ontoWisbench5TablesNoPKPerformanceTestPostgres.obda";
