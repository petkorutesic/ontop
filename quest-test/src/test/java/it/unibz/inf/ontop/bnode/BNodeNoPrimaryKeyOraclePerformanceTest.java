 ...
 * comprised of a single table with no primary keys and with rows randomly generated by
...
public class BNodeNoPrimaryKeyOraclePerformanceTest extends TestCase {
    ...
    final String obdafile = "src/test/resources/bnode/ontoWisbenchNoPKPerformanceTestOracle.obda";
