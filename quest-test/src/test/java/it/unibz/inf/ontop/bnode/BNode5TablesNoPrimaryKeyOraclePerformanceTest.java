...
/***
 * Performance test for the use of unlabeled blank nodes in mappings with an Oracle database
 ...
 */
public class BNode5TablesNoPrimaryKeyOraclePerformanceTest extends TestCase {
    final static Logger log = LoggerFactory.getLogger(BNode5TablesNoPrimaryKeyOraclePerformanceTest.class);
    ...
    final String obdafile = "src/test/resources/bnode/ontoWisbench5TablesNoPKPerformanceTestOracle.obda";
