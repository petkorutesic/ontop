 ...
 */
public class DollarMappingTest {
	...
	final String owlfile = "src/test/resources/dollarDatabase.owl";
	final String obdafile = "src/test/resources/dollarDatabase.obda";
	...
	public void setUp() throws Exception {
			 ...
			 sqlConnection= DriverManager.getConnection("jdbc:h2:mem:dollar","sa", "");
...
//			    	Server.startWebServer(sqlConnection);
	...
	public void testDollar() throws Exception {
		String query =  "PREFIX : <http://www.semanticweb.org/small$Database#> SELECT ?x ?y \n" +
                "WHERE {\n" +
